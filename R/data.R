...
#'  The training set mnist$train is a list with two entries: images and labels,
#'  located at mnist$train$images, mnist$train$labels respectively.
#'  The dataset mnist$train$images is a matrix of size 55000x784, 
#'  the labels mnist$train$labels is a matrix of size 55000x10.
#'  The test set mnist$test is a list with two entries: images and labels,
#'  located at mnist$test$images, mnist$test$labels respectively.
#'  The dataset mnist$test$images is a matrix of size 10000x784, 
