...
#'
runSGLD = function( logLik, logPrior, data, params, stepsize, n, nIters = 10^4, verbose = TRUE ) {
    # Create SGLD object
    sgmcmc = sgld( logLik, logPrior, data, params, stepsize, n, NULL )
...
runSGLDCV = function( logLik, logPrior, data, paramsRaw, stepsize, optStepsize, 
    ...
    # Setup SGLDCV object
    sgmcmcCV = sgldCV( logLik, logPrior, data, paramsRaw, stepsize, optStepsize, n, NULL )
